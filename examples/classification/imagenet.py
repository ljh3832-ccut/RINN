...
import sys
sys.path.append("D:/TorchIntegral-main")
...
parser.add_argument(
    ...
    nargs="?",
    default="C:/ImageNet",
    help="path to dataset (default: C:/ImageNet)",
)
parser.add_argument(
...
# MODEL
def imagenet_model(pretrained=True):
    # load model
    PARAMS = {
...
model = IntegralWrapper(
    ...
    start_lr=1e-3,
    verbose=True,
)(model, [1, 3, 224, 224], continuous_dims)
